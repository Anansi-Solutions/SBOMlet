...
/**
 * True when a finding's elected branch is composed ENTIRELY of LicenseRef-/DocumentRef- leaves.
 * Defensive: elected was rendered by renderNode(elect(...)) so it parses by construction; the catch
