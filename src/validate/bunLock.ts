/**
 * arktype boundary for the bun.lock document, post-JSONC-strip (tolerant posture). A failed narrow
 * takes the caller's existing record-narrow-undefined path; per-entry spec extraction (specOf,
 * splitSpec) stays explicit code in the collector.
 */
