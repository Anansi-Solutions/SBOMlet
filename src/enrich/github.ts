...
/**
 * Resolve a raw GitHub license from an already-fetched License API body. Narrows the untrusted body
 * first (malformed → null, never a throw), then returns the spdx_id verbatim. A NOASSERTION/null
 * spdx_id is a DEFINITIVE no-license answer → null. The download_url is carried through for OUT-02.
 */
